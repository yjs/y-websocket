...
- `test/reconnect.test.js` — reconnect/backoff and close-code semantics; uses a purpose-built `ws` server on an ephemeral port so tests can control the close code and observe reconnect timing.
